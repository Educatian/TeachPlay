...
(() => {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      '  background: #fff; border: 1px solid #d9d4cc; border-radius: 4px;',
      '  padding: 3px 4px 3px 12px; box-shadow: 0 2px 8px rgba(16,24,40,.08);',
      ...
      '  width: 32px; height: 32px; min-width: 32px; min-height: 32px; border-radius: 4px; font-size: 13px;',
      '  display: flex; align-items: center; justify-content: center; flex: 0 0 auto;',
      '}',
      '#tp-app-search .site-header__search-btn:hover { background: #9c1526; }',
      '#tp-app-search .site-header__search:focus-within {',
      '  border-color: #be1a2f;',
      '  box-shadow: 0 0 0 2px rgba(190,26,47,.14);',
      '}',
