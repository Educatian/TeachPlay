// Vendored OpenBadges v3.0 JSON-LD context (context-3.0.3.json), fetched from
// https://purl.imsglobal.org/spec/ob/v3p0/context-3.0.3.json so the Worker
// verifier can resolve it offline (its documentLoader refuses network fetches
// to stay SSRF-safe). Do not hand-edit: canonicalization must match the signer.
export default {
  "@context": {
    "@protected": true,
    "id": "@id",
