...
(function () {
  ...
  function trackSearch() {
    // Hook into the search-box input. Once the user types ≥ 3 chars, unlock.
    document.querySelectorAll('form.site-header__search input').forEach(function (input) {
      var fired = false;
